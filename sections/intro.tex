  ...
  \begin{frame}{Research question}
    \begin{columns}[T]
      ...
      \begin{textcolumn}
        ...
        %TODO: what does this even mean lol. make it simpler, more understandable
      \end{textcolumn}
    \end{columns}
  \end{frame}
}
...
% TODO: make these damn references smaller in font or smth, theyre massive
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        \item von Neumann's automata\cite{vonneumann} and Ray's
          ...
          and RAM.
        \item DAOs and autonomic computing --- decentralized control over
          virtual, quota-based resources. % this needs to be more understandable, makes no sense.
      \end{itemize}
